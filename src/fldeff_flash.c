...
static const struct FlashStruct sTransitionTypes[] =
{
    ...
    {MAP_TYPE_MOUNTAIN,    MAP_TYPE_UNDERGROUND,  TRUE, FALSE, DoEnterCaveTransition},
    {MAP_TYPE_SAND,        MAP_TYPE_UNDERGROUND,  TRUE, FALSE, DoEnterCaveTransition},
    ...
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_MOUNTAIN,    FALSE,  TRUE, DoExitCaveTransition},
    {MAP_TYPE_UNDERGROUND, MAP_TYPE_SAND,        FALSE,  TRUE, DoExitCaveTransition},
