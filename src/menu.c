...
u32 GetPlayerTextSpeed(void)
{
    ...
    return gSaveBlock4Ptr->optionsTextSpeed;
}

u8 GetPlayerTextSpeedDelay(void)
{
    u32 speed;
    if (gSaveBlock4Ptr->optionsTextSpeed > OPTIONS_TEXT_SPEED_FAST)
        gSaveBlock4Ptr->optionsTextSpeed = OPTIONS_TEXT_SPEED_MID;
