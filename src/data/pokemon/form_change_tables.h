...
static const struct FormChange sBurmyFormChangeTable[] = {
    ...
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_GRASS2},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_GRASS3},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_FOREST},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_CITY},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_SAND},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_WATER_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_BEACH},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_WATER},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_UNDERWATER},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_TRASH, BATTLE_ENVIRONMENT_BUILDING},
    // Night Battle Environments
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_GRASS},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_GRASS2},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_GRASS3},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_FOREST},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_CITY},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_NIGHT_SAND},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_NIGHT_MOUNTAIN},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_NIGHT_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_SANDY, BATTLE_ENVIRONMENT_NIGHT_WATER_CAVE},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_BEACH},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_WATER},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_PLANT, BATTLE_ENVIRONMENT_NIGHT_UNDERWATER},
    {FORM_CHANGE_END_BATTLE_ENVIRONMENT, SPECIES_BURMY_TRASH, BATTLE_ENVIRONMENT_NIGHT_BUILDING},
    {FORM_CHANGE_TERMINATOR},
};
