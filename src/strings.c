...
const u8 gText_FrameTypeRed[] = _("{COLOR LIGHT_RED}Red");
const u8 gText_FrameTypeAqua[] = _("{COLOR GREEN}Aqua");
const u8 gText_FrameTypeWhite[] = _("{COLOR LIGHT_GREEN}White");
const u8 gText_FrameTypeYellow[] = _("{COLOR BLUE}Yellow");
