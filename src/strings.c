...
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Medium");
...
const u8 gText_FrameTypeRed[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Red");
const u8 gText_FrameTypeAqua[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Aqua");
const u8 gText_FrameTypeWhite[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}White");
const u8 gText_FrameTypeYellow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Yellow");
