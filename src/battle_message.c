...
const u8 gText_BattleMenu[] = _("{COLOR_HIGHLIGHT_SHADOW WHITE TRANSPARENT LIGHT_BLUE}Battle{CLEAR_TO 56}{COLOR_HIGHLIGHT_SHADOW LIGHT_GRAY TRANSPARENT LIGHT_BLUE}Bag\n{COLOR_HIGHLIGHT_SHADOW GREEN TRANSPARENT LIGHT_BLUE}Pokémon{CLEAR_TO 56}{COLOR_HIGHLIGHT_SHADOW BLUE TRANSPARENT LIGHT_BLUE}Run");
